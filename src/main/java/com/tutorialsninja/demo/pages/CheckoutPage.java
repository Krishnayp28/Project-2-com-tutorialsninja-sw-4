...
public class CheckoutPage extends Utility {
    ...
    public void enterBillingDetails()  {
        sendTextToElement(firstName, "jigna");
        sendTextToElement(lastName, "Patel");
        sendTextToElement(email, "Patel"+getAlphaNumericString(4)+"@gmail.com");
        sendTextToElement(telephone, "07654321234");
        sendTextToElement(address, "15 Thousand Road");
        sendTextToElement(city, "Northwood");
        sendTextToElement(postCode, "HA61SY");
        selectByVisibleTextFromDropDown(country, "United Kingdom");
        selectByVisibleTextFromDropDown(regionOrState, "Hillgdon");
    }
